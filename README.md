# ІСтаТП · ЛР1 «Месенджер» (ASP.NET Core MVC) — гілка етапу 1.6

**Виконавець:** Костащук Ярослав Васильович, група К26 · **Викладач:** Панченко Т. В.

Ця гілка показує стан проєкту на **етапі 1.6**. Нижче — що додано або змінено на кожному етапі (до цього включно).
...
- **Етап 1.6** — додано експорт та імпорт повідомлень у форматі Excel (ClosedXML) у `MessagesController`.  ◀ **цей етап (гілка)**
