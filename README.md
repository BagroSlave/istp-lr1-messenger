# ІСтаТП · ЛР1 «Месенджер» (ASP.NET Core MVC) — гілка етапу 1.4

**Виконавець:** Костащук Ярослав Васильович, група К26 · **Викладач:** Панченко Т. В.

Ця гілка показує стан проєкту на **етапі 1.4**. Нижче — що додано або змінено на кожному етапі (до цього включно).
...
- **Етап 1.4** — додано майстер-сторінку `_Layout.cshtml` і стилізацію (`wwwroot/css/site.css`).  ◀ **цей етап (гілка)**
